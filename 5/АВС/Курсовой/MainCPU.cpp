      ...
      case 'b':
        if (i + 1 < argc) {
          ...
          if (str == "AT") {
            ...
            strategy = BranchPredictor::Strategy::RAND;
          } else if (str=="SB") {
            strategy = BranchPredictor::Strategy::SB;
          } else if (str=="STB"){
            strategy = BranchPredictor::Strategy::STB;
          } else if (str=="PP"){
            strategy = BranchPredictor::Strategy::PP;
          } else if (str=="HP"){
            strategy = BranchPredictor::Strategy::HP;
          } else {
            return false;
          }
        } else {
